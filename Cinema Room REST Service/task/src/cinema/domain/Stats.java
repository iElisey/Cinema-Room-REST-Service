...
public class Stats {
    ...
    public void minusCurrent_income(int current_income) {
        this.current_income -= current_income;
    }
    ...
    public void minusNumber_of_available_seats(int number_of_available_seats) {
        this.number_of_available_seats -= number_of_available_seats;
    }
    ...
    public void minusNumber_of_purchased_tickets(int number_of_purchased_tickets) {
        this.number_of_purchased_tickets -= number_of_purchased_tickets;
    }
